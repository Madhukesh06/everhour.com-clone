          ...
          <HStack w={{ base: "100%", sm: "50%" }}>
            ...
            <VStack fontSize="18px" textAlign="left">
              <Text>
                ...
                <Highlight
                  query="Without Everhour, we would be unable to accurately track the
                  hours associated with each individual project we are working on
                  as a company."
                ...
                The reports are easily customizable which allows me to extract the
                data I need. Everhour is a great tool for our time tracking needs!
              </Text>
