      ...
      <Box pos="relative" overflow={"hidden"}>
         ...
         >
            ...
            <Text fontSize={"lg"} color={"gray.600"}>
               join 35000 customers+ who use Everhour to track time and plan
         ...
         >
            ...
            >
               ...
               >
                  ...
                  <br></br> my sub contractors.All team members usethe
                  system_from web developers to techsupport to<br></br>{" "}
                  projectmanagement to design"
                  <br></br>
               ...
               >
                  ...
                  is speed,flexibility,ability to integrate with all major
                  project management software And Everhour is exactly that kind
                  of software."
               </Box>
               ...
               <Box
                  ...
                  paddingTop="60px"
               >
                  "Everhour's intergration with Asana is Wonderful for a remote
                  team. We track all activites in Asana, but before Everhour I{" "}
                  <span style={{ backgroundColor: " rgba(250,247,133,0.7)" }}>
                     {" "}
                     often wondered how long it was taking to do a task, now i
                     know exactly. i can see who is working right now and{" "}
                  </span>{" "}
                  a summary each day"{" "}
               </Box>
            </Stack>
            ...
            >
               ...
               >
                  ...
                  ,in every level[software development,meetings,project
                  management, etc]"
               ...
               <Box
                  ...
                  paddingTop="60px"
               >
                  “We are a 15 people team working remotely from different
                  cities of{" "}
                  <span style={{ backgroundColor: " rgba(250,247,133,0.7)" }}>
                     {" "}
                  ...
                  been using Everhour for the past year or so, and it has become
                  ...
                  in order to be completed next time and by who. Easily create
                  and save reports with just a few clicks”
               </Box>
            </Stack>
            ...
            >
               <Box
                  ...
                  paddingTop="60px"
               >
                  Everhour helps me to manage/plan my weekly activities a lot
                  more effectively.Since i know how much time I have to work
                  onthing each day,and can{" "}
                  <span style={{ backgroundColor: " rgba(250,247,133,0.7)" }}>
                     quickly update estimated times to reallocate tasks as
                     needed'
                  </span>
               ...
               >
                  ...
                  <span style={{ backgroundColor: " rgba(250,247,133,0.7)" }}>
                     ...
                     track our task in real - time without{" "}
                  </span>
                  having leave the browser. The chrome add_on helps to initiate
                  the timefor aspecific task.If we are already on Asana, A
                  simple click does the job"
               ...
               <Box
                  ...
                  paddingTop="60px"
               >
                  “Everhour has already paid for itself for the year by helping
                  me track time I was missing in client projects.{" "}
                  <span style={{ backgroundColor: " rgba(250,247,133,0.7)" }}>
                     It is easy to use, has friendly customer service people,
                     and the
                  </span>{" "}
